...
public class FlutterSecureStorageDarwinPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
    ...
    private func parseCall(_ call: FlutterMethodCall) -> (KeychainQueryParameters, String?) {
        ...
        let parameters = KeychainQueryParameters(
            ...
            // Vizor patch: flutter_secure_storage 10.x sends this option as
            // "usesDataProtectionKeychain", but upstream 0.2.0 only read the
            // old "useDataProtectionKeyChain" spelling, silently forcing the
            // data-protection keychain on. Accept both spellings.
            usesDataProtectionKeychain: ((options["usesDataProtectionKeychain"]
